...
- Akuma — stable shoto first; option density opens later under a 9000-health risk budget.
- Luke — stable +36 route first; Perfect Flash Knuckle is execution investment, not an entry ticket.
- Terry — specials keep distinct roles: carry, damage, plus pressure and route extension are not one automatic string.
- Sagat — Tiger Shot changes movement first; long normals / Uppercut convert that reaction, while +42 Knee safe jump remains airborne-state conditioned.
